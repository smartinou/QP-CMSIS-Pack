...
PACK_DIRS="
    qp/qpc/3rd_party/embOS-gnu/
    qp/qpc/3rd_party/embOS-iar/
    qp/qpc/3rd_party/threadx/
    qp/qpc/3rd_party/uC-OS2/
    qp/qpc/include/
    qp/qpc/LICENSES/
    qp/qpc/ports/arm-cm/qk/
    qp/qpc/ports/arm-cm/qv/
    qp/qpc/ports/arm-cm/qxk/
    qp/qpc/ports/embos/
    qp/qpc/ports/freertos/
    qp/qpc/ports/lint-plus/
    qp/qpc/ports/threadx/
    qp/qpc/ports/uc-os2/
    qp/qpc/src/
    qp/qpc/test/
"
...
function preprocess() {
  ...
  git clone https://github.com/QuantumLeaps/qpc.git --recurse-submodules --depth 1 --branch ${PACK_VERSION}

  # Silent warnings for GCC .s files.
  mv qpc/3rd_party/uC-OS2/Ports/ARM-Cortex-M/ARMv6-M/GNU/os_cpu_a.s qpc/3rd_party/uC-OS2/Ports/ARM-Cortex-M/ARMv6-M/GNU/os_cpu_a.S
  mv qpc/3rd_party/uC-OS2/Ports/ARM-Cortex-M/ARMv7-M/GNU/os_cpu_a.s qpc/3rd_party/uC-OS2/Ports/ARM-Cortex-M/ARMv7-M/GNU/os_cpu_a.S
